package io.github.xiaoyu.shirowebdemo.realm;
...
import io.github.xiaoyu.shirowebdemo.service.PermService;
import io.github.xiaoyu.shirowebdemo.service.RoleService;
import io.github.xiaoyu.shirowebdemo.service.UserService;
...
public class CustomRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if (username == null) {
            throw new AccountException("[x] Null usernames are not allowed by this realm.");
        }
        ...
        if (userDB == null) {
            throw new UnknownAccountException("[x] No account found for admin [" + username + "]");
        }
