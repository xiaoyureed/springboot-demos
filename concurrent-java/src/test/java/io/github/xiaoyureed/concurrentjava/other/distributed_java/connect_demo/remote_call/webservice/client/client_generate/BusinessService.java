 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://client.webservice.remote_call.connect_demo.distributed_java.other.concurrentjava.xiaoyureed.github.io/client_generate", wsdlLocation = "http://localhost:9527/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://client.webservice.remote_call.connect_demo.distributed_java.other.concurrentjava.xiaoyureed.github.io/client_generate", "BusinessService");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://client.webservice.remote_call.connect_demo.distributed_java.other.concurrentjava.xiaoyureed.github.io/client_generate", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://client.webservice.remote_call.connect_demo.distributed_java.other.concurrentjava.xiaoyureed.github.io/client_generate", "BusinessPort"), Business.class, features);
    }
